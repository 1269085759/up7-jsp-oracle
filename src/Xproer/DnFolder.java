...
public class DnFolder 
{
    ...
    public static int Add(DnFolderInf inf)
    {
		...
		sb.append("SEQ_dn_fd_id.NEXTVAL");
		...
		try {
			cmd.setString(1, inf.m_name);
			cmd.setInt(2, inf.m_uid);
			cmd.setString(3, inf.m_mac);
			cmd.setString(4, inf.m_pathLoc);
			cmd.setInt(5, inf.m_fdID);
    ...
    public static String GetFolderData(int fid,FolderInf root)
    {
        ...
        sb.append(" left join hup_files as xf");
